...
<html lang="es" dir="ltr">
  <head>
    <meta charset="UTF-8">
    <title>Fitness Club Senior</title>
...
<script>
  ...
  switch (paqueteSelect.value) {
    case "Una Clase":
      precioInput.value = "125.00";
      break;
    case "Paquete 1 (Una clase a la semana)":
      if (diaDelMes >= 11) {
        precioInput.value = "405.00"; // 8% más que $375.00
      } else {
        precioInput.value = "375.00";
      }
      break;
    case "Paquete 2 (Dos clases a la semana)":
      if (diaDelMes >= 11) {
        precioInput.value = "669.60"; // 8% más que $620.00
      } else {
        precioInput.value = "620.00";
      }
      break;
    case "Paquete 3 (Sin límite de clases)":
      if (diaDelMes >= 11) {
        precioInput.value = "939.60"; // 8% más que $870.00
      } else {
        precioInput.value = "870.00";
      }
      break;
    default:
      precioInput.value = "";
