...
<?php
$lugar = "Cancha 5 de Bádminton";
$academia = "Danza Aérea";
$concepto = "DANZAAEREA";
$profesor = "Karina Torres";
$dias = "Miercoles y Viernes";
$horario = "15:00, 16:00, 17:00 y 18:00 horas"; 
?>
...
$sql = "SELECT * FROM actividades WHERE id = 5";
...
while ($fila = mysqli_fetch_assoc($resultado)) {
  ...
  echo '<span class="subtitulo">Horario:</span> ' . $fila['horario_grupo1'] . ', ' . $fila['horario_grupo2'] . ', '. $fila['horario_grupo3'] . ' y ' . $fila['horario_grupo4'] . '<br>';
