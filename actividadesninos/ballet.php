    ...
    <div class="container">
        ...
        <div class="content">
            <div class="left-side">
                ...
                <footer>
                    <center>
                        <p>© 2023 Club France. Todos los derechos reservados.</p>
                    </center>
                </footer>
            </div>
...
?>
         ...
         ?>
                    ...
                    <h5>¿Has apartado tu lugar en la clase? Antes de realizar el pago, asegúrate de apartar tu lugar con
                        el profesor: <p style="color:#3e2093" ;><?php echo $profesor; ?></p>
                    </h5>
                    ...
                    <div id="mi-elemento">
                        <input type="text" id="academia" name="academia" value="<?=$academia?>" placeholder="" readonly
                            hidden>
                    </div>

                    <div id="mi-elemento">
                        <input type="text" id="profesor" name="profesor" value="<?=$profesor?>" placeholder="" readonly
                            hidden>
                    </div>
                    ...
                    <div id="mi-elemento">
                        <input type="text" id="horario" name="horario" value="<?=$horario?>" placeholder="" readonly
                            hidden>
                    </div>
                    ...
                    <div id="mi-elemento">
                        <input type="text" id="concepto" name="concepto" value="<?=$concepto?>" placeholder="" readonly
                            hidden>
                    </div>
                    ...
                    <div class="input-box">
                        ...
                        <input id="numero_usuario" name="numero_usuario" type="text"
                            placeholder="Número de usuario del niño o niña" required>
                    </div>
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            <div class="custom-control custom-checkbox">
                                <input type="checkbox" class="custom-control-input" id="reglamento" name="reglamento"
                                    value="Sí" required>
                                <label class="custom-control-label" for="aviso">He Leído y Acepto el <a href=""
                                        target="_blank" class="text-danger">Reglamento</a></label>
                    ...
                    <div class="col-md-12">
                        <span style="font-size: 10px;">
                            Los datos personales recopilados serán protegidos, almacenados y procesados con fines
                            estadísticos, promocionales y de mejora. La información obtenida es confidencial y es
                            propiedad de Club France, invitamos a consultar nuestro <a
                                href="https://clubfrance.org.mx/aviso_privacidad/Aviso_de_Privacidad.pdf"
                                target="_blank">Aviso de privacidad</a>. </span>
                    </div>
                    <br>
                ...
                function actualizarPrecio() {
                    ...
                    switch (paqueteSelect.value) {
                        ...
                        case "Paquete 2 (Dos horas a la semana)":
                            if (diaDelMes >= 11) {
                                precioInput.value = "885.6"; // 8% más que $820.00
                            } else {
