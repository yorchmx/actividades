...
<html lang="es" dir="ltr">
  <head>
    <meta charset="UTF-8">
    <title>Básquetbol Infantil</title>
...
$sql = "SELECT * FROM actividades WHERE id = 3";
...
while ($fila = mysqli_fetch_assoc($resultado)) {
  ...
  echo '<span class="subtitulo">Horario:</span> ' . $fila['grupo1'] . ' de ' . $fila['horario_grupo1'] . ' y ' . $fila['grupo2'] . ' de ' . $fila['horario_grupo2'] . '<br>';
