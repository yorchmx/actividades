...
$sql = $conexion->query( "INSERT INTO `registrosInfantiles` (`academia`, `profesor`, `dias`, `horario`, `apartado`, `nombre`, `apellido`, `numero_usuario`, `email`, `paquete`, `precio`, `folio`, `concepto`, `fecha_registro`, `reglamento`, `firma`) 
